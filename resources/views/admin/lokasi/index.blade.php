...
<div class="horizontal-menu">
    ...
    <div class="container mt-3">
        <div class="card">
            <div class="card-header p-2 d-flex justify-content-between" style="gap:10px">
                <button class="py-2 px-3 btn btn-success" data-bs-toggle="offcanvas" data-bs-target="#offcanvasLokasi" aria-controls="offcanvasLokasi">Tambah Lokasi</button>
            </div>
            <div class="card-body">
    ...
    <div class="offcanvas offcanvas-start" tabindex="-2" id="offcanvasLokasi" aria-labelledby="offcanvasLokasiLabel">
        <div class="offcanvas-header">
            <h5 class="offcanvas-title" id="offcanvasLokasiLabel">Form Lokasi</h5>
