...
@section('content')
    <div class="container">
        <div class="d-flex justify-content-between">
            ...
            <form action="{{ route('cetak.packingList.kubikasi') }}" method="get" class="d-flex" style="gap:5px">
                        ...
                        <table class="table border-dark border-y" style="font-size: .7rem">
                            <thead>
                                <tr class="border border-dark">
                                    ...
                                    <th class="text-center border-x border-dark">P</th>
                                    <th class="text-center border-x border-dark">L</th>
                                    <th class="text-center border-x border-dark">T</th>
                                    <th class="text-center border-x border-dark">M3</th>
                            ...
                            <tbody>
                                ...
                                @foreach ($data as $bttb)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center border-x border-dark">{{ $item->vol }}</td>
                            ...
                            {{-- <tfoot class="border border-dark">
                                <tr>
                                    ...
                                    <td class="border border-dark"></td>
                                    <td class="border border-dark"></td>
                                    <td class="border border-dark text-center">{{ $jumlah_vol }}</td>
                                    <td class="border border-dark"></td>
                                    <td class="border border-dark"></td>
                                </tr>
                            </tfoot> --}}
