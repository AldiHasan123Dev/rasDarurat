    ...
    <div class="container mt-3">
        ...
        <div class="card mt-3">
            <div class="card-header py-2 px-5 d-flex justify-content-between" style="gap:10px">
                ...
                <div class="d-flex gap-2">
                    <a href="" class="btn btn-sm btn-success" id="cetak-invoice"><i class="fas fa-print"></i> Cetak
                        Invoice Global</a>
                    <a href="" class="btn btn-sm btn-success" id="cetak-cont-invoice"><i class="fas fa-print"></i>
                        Cetak Invoice Per Cont</a>
                </div>
        ...
        <div class="card mt-3">
            <div class="card-header py-2 px-5 d-flex justify-content-between" style="gap:10px">
                ...
                <div class="d-flex gap-2">
                    <a href="" class="btn btn-sm btn-success" id="cetak-invoice2"><i class="fas fa-print"></i> Cetak
                        Invoice Global</a>
                    <a href="" class="btn btn-sm btn-success" id="cetak-cont-invoice2"><i class="fas fa-print"></i>
                        Cetak Invoice Per Cont</a>
                </div>
        ...
        <div class="card mt-3">
            <div class="card-header py-2 px-5 d-flex justify-content-between" style="gap:10px">
                <div class="card-titles">List Pre Invoice Customer Khusus</div>
                <div class="d-flex gap-2">
                    <a href="" class="btn btn-sm btn-success" id="cetak-invoice3"><i class="fas fa-print"></i> Cetak
                        Invoice Global</a>
                    <a href="" class="btn btn-sm btn-success" id="cetak-cont-invoice3"><i class="fas fa-print"></i>
                        Cetak Invoice Per Cont</a>
                </div>
                <p>No JOB: <span class="nojob3"></span></p>
            </div>
            <div class="card-body">
...
@section('script')
    ...
    <script>
        ...
        let dataKhusus = @json($dataKhusus);
        $("#jqGrid1").jqGrid({
            datatype: 'local',
            data: data1,
            colModel: [{
        ...
        $("#jqGrid3").jqGrid({
            ...
            onCellSelect: function(rowId, iRow, iCol, e) {
                ...
                var no = $(this).jqGrid('getCell', rowId, 'no');
                $('.nojob3').html(no);
                $('#cetak-invoice3').attr('href', '{{ route('cetak.invoice') }}?order_id=' + id);
                $('#cetak-cont-invoice3').attr('href', '{{ route('cetak.invoice.cont') }}?order_id=' + id);
            },
            rowattr: function(item) {
                return {
                    "class": item.class
