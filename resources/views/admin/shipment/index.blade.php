...
<div class="horizontal-menu">
    <div class="d-flex gap-2 flex-nowrap" style="overflow-x:auto">
        <div class="sub-menu">
            <a href="{{ route('shipment.index') }}" class="btn-link p-3">Data Shipment <span class="nav-link-icon"></span></span></a>
        </div>
        <div class="sub-menu">
    ...
    <div class="container mt-3">
        <div class="card">
            <div class="card-header p-2 d-flex justify-content-between" style="gap:10px">
                <button class="py-2 px-3 btn btn-success" data-bs-toggle="offcanvas" data-bs-target="#offcanvasShipment" aria-controls="offcanvasShipment">Tambah Shipment</button>
            </div>
            <div class="card-body">
    ...
    <div class="offcanvas offcanvas-start" tabindex="-2" id="offcanvasShipment" aria-labelledby="offcanvasShipmentLabel">
        <div class="offcanvas-header">
            <h5 class="offcanvas-title" id="offcanvasShipmentLabel">Form Shipment</h5>
