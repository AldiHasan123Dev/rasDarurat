<div class="row">
    ...
    <x-input :value="$order->pengirim_id??old('pengirim_id')" :col="3" :label="'Pengirim'" :type="'select'" :options="$customers" :name="'pengirim_id'" :required="true"></x-input>
    <x-input :value="$order->penerima_id??old('penerima_id')" :col="3" :label="'Penerima'" :type="'select'" :options="$customers" :name="'penerima_id'" :required="true"></x-input>
    ...
    <div class="col-3" id="nag">
        <x-input :value="$order->penerima_bl_id??old('penerima_bl_id')" :label="'Penerima BL'" :type="'select'" :options="$customers ?? []" :name="'penerima_bl_id'"></x-input>
    </div>
