        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-auto">
                        <button type="button" class="btn btn-bank" onclick="setJurnal('Jurnal')"
                            id="btn-jnl">Jurnal</button>
                        <input type="hidden" name="jurnal" id="jurnal" value="">
                    </div>
                    <div class="col-auto">
                        <button type="button" class="btn btn-bank" onclick="setBkt('bkt')" id="btn-bkt">Bank
                            Trucking</button>
                        <input type="hidden" name="bkt" id="bkt" value="">
                    </div>
                    <div class="col-auto">
                        <button type="button" class="btn btn-bank" onclick="setBank7993('bank7993')" id="btn-bank7993">Bank
                            7993</button>
    ...
    <script>
        ...
        $("#jqGrid1").jqGrid({
            ...
            onCellSelect: function(rowId, iRow, iCol, e) {
                ...
                $('#edit-coa1').attr('href', @json(route('jurnal.edit.coa')) + '?jurnal=' + encodeURIComponent(
                    nomor));
