@php
    $coas = App\Models\COA::where('is_active',1)->pluck('nama','id');
@endphp

<div class="row">
<x-input :options="$coas" :value="$coa->coa_id??old('coa_id')" :col="6" :label="'COA ID'" :type="'select'" :name="'coa_id'" :required="true"></x-input>
...
<x-input :value="$coa->keterangan??old('keterangan')" :col="6" :label="'Keterangan'" :type="'text'" :name="'keterangan'" :required="true"></x-input>
