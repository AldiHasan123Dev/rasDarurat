    ...
    <div class="col-6">
        <table class="table table-sm" style="font-size: .7rem">
            ...
            <tbody>
                ...
                @php
                    $total_penjualan_usaha += $item->jurnals()->whereYear('created_at',$year)->sum('credit') - $item->jurnals()->whereYear('created_at',$year)->sum('debit');
                @endphp
                <tr>
                    <td>{{ $item->kode }}</td>
                    <td>{{ $item->nama }}</td>
                    <td class="text-end">{{ number_format($item->jurnals()->whereYear('created_at',$year)->sum('credit') - $item->jurnals()->whereYear('created_at',$year)->sum('debit'),2,',','.') }}</td>
                </tr>
                @endforeach
                <tfoot>
                    <tr>
        ...
        <table class="table table-sm" style="font-size: .7rem">
            ...
            <tbody>
                ...
                @foreach ($hpp as $item)
                @php
                    $total_hpp += $item->jurnals()->whereYear('created_at',$year)->sum('debit') - $item->jurnals()->whereYear('created_at',$year)->sum('credit');
                @endphp
                <tr>
                    <td>{{ $item->kode }}</td>
                    <td>{{ $item->nama }}</td>
                    <td class="text-end">{{ number_format($item->jurnals()->whereYear('created_at',$year)->sum('debit') - $item->jurnals()->whereYear('created_at',$year)->sum('credit'),2,',','.') }}</td>
                </tr>
                @endforeach
                <tfoot>
                    <tr>
        ...
        <table class="table table-sm" style="font-size: .7rem">
            ...
            <tbody>
                ...
                @php
                    $total_biaya_usaha += $item->jurnals()->whereYear('created_at',$year)->sum('debit') - $item->jurnals()->whereYear('created_at',$year)->sum('credit');
                @endphp
                <tr>
                    <td>{{ $item->kode }}</td>
                    <td>{{ $item->nama }}</td>
        ...
        <table class="table table-sm" style="font-size: .7rem">
            ...
            <tbody>
                ...
                @php
                    $total_biaya_depresiasi += $item->jurnals()->whereYear('created_at',$year)->sum('debit') - $item->jurnals()->whereYear('created_at',$year)->sum('credit');
                @endphp
                <tr>
                    <td>{{ $item->kode }}</td>
                    <td>{{ $item->nama }}</td>
        ...
        <table class="table table-sm" style="font-size: .7rem">
            ...
            <tbody>
                ...
                @php
                    $total_biaya_lain += $item->jurnals()->whereYear('created_at',$year)->sum('debit') - $item->jurnals()->whereYear('created_at',$year)->sum('credit');
                @endphp
                <tr>
                    <td>{{ $item->kode }}</td>
                    <td>{{ $item->nama }}</td>
        ...
        <table class="table table-sm" style="font-size: .7rem">
            ...
            <tbody>
                ...
                @php
                    $total_biaya_keuangan1 += $item->jurnals()->whereYear('created_at',$year)->sum('debit') - $item->jurnals()->whereYear('created_at',$year)->sum('credit');
                @endphp
                <tr>
                    <td>{{ $item->kode }}</td>
                    <td>{{ $item->nama }}</td>
        ...
        <table class="table table-sm mt-3" style="font-size: .7rem">
            ...
            <tbody>
                ...
                @php
                    $total_biaya_keuangan2 += $item->jurnals()->whereYear('created_at',$year)->sum('debit') - $item->jurnals()->whereYear('created_at',$year)->sum('credit');
                @endphp
                <tr>
                    <td>{{ $item->kode }}</td>
                    <td>{{ $item->nama }}</td>
