...
class CRUD extends Command
{
    ...
    public function handle()
    {
        ...
        for ($i=0; $i < $j; $i++) {
            ...
            if($std=='execute'){
                ...
                $datatable = "Route::get('".strtolower($model_name)."',[App\\Http\\Controllers\\".$model_name."Controller::class,'datatable'])->name('".strtolower($model_name).".data');";
                ...
                // fwrite($fp, $menu);
                if (!file_exists(base_path('resources/views/desktop'))) {
                    mkdir(base_path('resources/views/desktop'), 0777);
                }
    ...
    public function viewForm(array $data, $model_name)
    {
        ...
        $form = fopen(base_path('resources/views/desktop/'.strtolower($model_name))."/form.blade.php","wb");
        fwrite($form, $content);
        fclose($form);
    }
