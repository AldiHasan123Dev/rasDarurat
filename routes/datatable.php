...
Route::post('customertrucking',[App\Http\Controllers\CustomerTruckingController::class,'datatable'])->name('customertrucking.data');Route::post('kendaraan',[App\Http\Controllers\KendaraanController::class,'datatable'])->name('kendaraan.data');Route::post('sopir',[App\Http\Controllers\SopirController::class,'datatable'])->name('sopir.data');Route::post('sangusopir',[App\Http\Controllers\SanguSopirController::class,'datatable'])->name('sangusopir.data');